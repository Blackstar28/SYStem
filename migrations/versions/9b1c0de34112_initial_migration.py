...
Revision ID: 9b1c0de34112
Revises: 
Create Date: 2025-03-22 11:25:57.290774
...
def upgrade():
    ...
    with op.batch_alter_table('supplier', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint("uq_supplier_email", ['email'])  # ✅ Named constraint
